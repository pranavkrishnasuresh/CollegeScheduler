...
public class AssignmentsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        listView = rootView.findViewById(R.id.listViewAssignments);
        button = rootView.findViewById(R.id.buttonAssignments);
    ...
    private void addItem(View view) {
        ...
        EditText nameinput = getView().findViewById(R.id.editTextAssignments);
        ...
        if (!classText.equals("") || !dateText.equals("") || !nameText.equals("")) {
            itemsAdapter.add(nameText + " for " + classText + " due " + dateText);
            classinput.setText("");
            dateinput.setText("");
            nameinput.setText("");
        } else {
